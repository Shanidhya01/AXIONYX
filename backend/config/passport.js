...
if (process.env.GITHUB_CLIENT_ID && process.env.GITHUB_CLIENT_SECRET) {
    const githubCallbackUrl =
        ...
        (process.env.SERVER_URL ? `${process.env.SERVER_URL.replace(/\/+$/, '')}/api/auth/github/callback` : '/api/auth/github/callback');
    ...
    console.warn('[passport] GitHub OAuth disabled: set GITHUB_CLIENT_ID and GITHUB_CLIENT_SECRET to enable it.');
}